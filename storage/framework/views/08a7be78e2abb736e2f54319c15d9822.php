    ...
    <div class="row align-items-center mb-4 g-3">
        ...
        <div class="col-md-6 text-md-end">
            <span class="badge bg-light text-dark border px-3 py-2 rounded-pill shadow-2xs fw-normal fs-6">
                <i class="bi bi-calendar3 me-2 text-primary"></i><?php echo e($tanggalHariIni->translatedFormat('l, d F Y')); ?>
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100 p-2">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold text-dark mb-0">Rp <?php echo e(number_format($ringkasan['total_penjualan'], 0, ',', '.')); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold text-dark mb-0">
                                <?php echo e($ringkasan['total_transaksi']); ?> <span class="fs-7 text-muted fw-normal">Selesai</span>
                            </h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100 p-2">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold text-dark mb-0">Rp <?php echo e(number_format($ringkasan['total_cash'], 0, ',', '.')); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100 p-2">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold text-dark mb-0">Rp <?php echo e(number_format($ringkasan['total_non_tunai'], 0, ',', '.')); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-0">
                    <div class="row g-0">
                        <div class="col-md-6 border-end p-3">
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody class="border-top-0 fs-7">
                                        <?php $__empty_1 = true; $__currentLoopData = $produkStokRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
                                            <tr>
                                                <td class="text-muted fw-semibold"><?php echo e($produkStokRendah->firstItem() + $index); ?></td>
                                                <td class="fw-bold text-dark text-truncate" style="max-width: 130px;"><?php echo e($produk->nama); ?></td>
                                                <td class="text-end">
                            ...
                            <div class="mt-3 fs-sm d-flex justify-content-end"><?php echo e($produkStokRendah->links()); ?></div>
                        </div>
                        ...
                        <div class="col-md-6 p-3">
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody class="border-top-0 fs-7">
                                        <?php $__empty_1 = true; $__currentLoopData = $produkStokHabis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
                                            <tr>
                                                <td class="text-muted fw-semibold"><?php echo e($produkStokHabis->firstItem() + $index); ?></td>
                                                <td class="fw-bold text-dark text-truncate" style="max-width: 130px;"><?php echo e($produk->nama); ?></td>
                                                <td class="text-end">
                            ...
                            <div class="mt-3 fs-sm d-flex justify-content-end"><?php echo e($produkStokHabis->links()); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-3">
                                            <span class="badge bg-success-subtle text-success border border-success-subtle px-2.5 py-1 rounded-pill fw-semibold">
                                                <i class="bi bi-graph-up-arrow me-1"></i><?php echo e($produk->total_terjual); ?>
